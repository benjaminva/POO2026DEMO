...
/**
  * @brief Clase que representa un Asignacion
  *
  * Contiene la información sobres las asignaciones entre vehículos y clientes.
  *
...
private:
  ...
  /**
   * @brief obtiene el indice numérico de una ubicación
   * @param ubicacion String de la ubicación de la que se obtendra en indice en
   * la matriz de distancias
   * @return int indice del string que corresponde a la matriz de distancias.
   */
...
public:
  ...
  /**
   * @brief obtiene una cadena con tdoas las ubicaciones
   * @return string con todas la ubicaciones registradas en el arreglo de
   * ubicaciones.
   */
